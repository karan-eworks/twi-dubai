...
function AboutPurposeSection({ heading, html }: AboutPurposeSectionProps) {
  return (
          ...
          <TypeSetComponent
            content={
              html ? (
                ...
                <>
                  <p>
                    The Woolwich Institute is an international academic
                    institution in Dubai offering accredited vocational
                    qualifications in a student-friendly environment. Programmes
                    span Business, Computing, Hospitality, Teacher Training, and
                    ACCA, with learning built around practical scenarios and
                    career preparation.
                  </p>
                  <p>
                    As part of The British Education Group, TWI benefits from an
                    international education network and progression experience.
                    The institute is KHDA licensed and Pearson approved, giving
                    students and families clear proof points before they apply.
                  </p>
                </>
              )
            }
